          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="order-2 lg:order-2">
              <div className="space-y-4 text-lg text-gray-600 leading-relaxed mb-8">
                <p>
                  Con más de <strong className="text-gray-900">5+ años de experiencia</strong> en la industria del software, he trabajado con empresas de diversos sectores ayudándolas a transformar sus desafíos en soluciones tecnológicas escalables.
                </p>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-2">
              ...
              <div className="flex items-center gap-4">
                <a href="https://www.linkedin.com/in/pandrebad/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-gray-600">
